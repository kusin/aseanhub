        ...
        <div class="col-sm-12">
            <div class="callout callout-danger">
                <span class="text-dark">
                    <i class="fa-solid fa-book mr-2"></i>Delete Data Participants
                </span>
            </div>
            {{-- callout --}}
        </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card card-outline card-danger">
                <div class="card-body">
                    <form action="{{ route('admin.participants.destroy', $data->id_participants) }}" method="post" enctype="multipart/form-data">

                        @csrf
                        @method('DELETE')
                        @include('backend.admin.participants._form', ['readonly' => true])
